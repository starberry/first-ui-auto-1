    ...
    const data = useStaticQuery(
        graphql`
            query {
                ...
                allStrapiProperty(
                    filter: {featured: {eq: true}, search_type: {eq: "lettings"}, publish: {eq: true}}
                  ) {
                    edges {
                      node {
                        id
                                        ...
                                        <ScrollAnimation animateIn="animate__slideInUp" animateOnce delay={i * 100} offset={100}>
                                            <div className="featured-properties-slide">
                                                ...
                                                <div className="featured-properties-text-wrapper">
                                                    <div className="price">{Site_Vars.default_currency}{node?.price?.toLocaleString()} {node.price_qualifier && node.price_qualifier !== "0" ? node.price_qualifier : ''}</div>
