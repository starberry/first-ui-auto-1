...
const FeaturedPropertiesLet = (props) => {
                ...
                <Container>
                    <Row>
                        <Col>
                            ...
                            <div className={`slider-text ${props.tag === "property-details" ? "" : "text-center"}`}>As well as these featured properties, we also have a number of off-market properties, so do <a href={`tel:${siteData?.company_phone}`}>give us a call.</a></div>
                                    ...
                                    return (
                                        ...
                                        <div className="featured-properties-slide">
                                            ...
                                            <div className="featured-properties-text-wrapper">
                                                <div className="price">{Site_Vars.default_currency}{item?.price?.toLocaleString()} {item.price_qualifier && item.price_qualifier !== "0" ? item.price_qualifier : ''}</div>
...
export default FeaturedPropertiesLet