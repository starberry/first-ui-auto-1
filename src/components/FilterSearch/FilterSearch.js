                        ...
                        <div className={`filter-search-features ${showFilter === true ? "filter-show" : ""}`}>
                            <Form className="refine-form" method="post" onSubmit={handleSubmit} onKeyPress={(e) => { e.key === 'Enter' && e.preventDefault(); }}>
                                <div className={`${showFilter === true ? "" : "d-flex align-items-center justify-content-between"}`}>
                                    {props.page_url_data && props.page_url_data?.propertyTypeVal !== "new_developments" &&
                                    ...
                                    {/*{
                                        showFilter === true ? "" :
                                        <>
                                            <ul className="d-md-none list-inline more-filters-btn-list d-flex justify-content-between">
                                                <li className="list-inline-item">
                                                    <div className="more-filters-btn-mobile">
                                                        <button className="more-filters-btn d-flex align-items-center justify-content-center" onClick={moreFilters}><i className="icon icon-more-filters"></i> Filters</button>
                                                    </div>
                                                ...
                                                <li className="list-inline-item">
                                                    <div className="more-filters-btn-mobile">
                                                        <button className="more-filters-btn d-flex align-items-center justify-content-center"><i className="icon icon-map-white"></i> Map</button>
                                                    </div>
                                                </li>
                                            </ul>
                                            <div className="d-xl-none d-md-block d-none search-more-filters">
                                                <button className="more-filters-btn" onClick={moreFilters}>More Filters <i className="icon icon-more-filters"></i></button>
                                            </div>
                                    ...
                                    }
                                    {
                                        ...
                                        <div className="filter-results-wrapper">
                                            ...
                                            <div className="dropdown-select more-filters">
                                                <Select
                                                    options={
                                                        [
                                                            { value: '', label: 'No Min' },
                                            ...
                                            <div className="search-btn-wrapper">
                                                <button className="button button-primary" onClick={moreFiltersShow}>Update Results</button>
                                            </div>        
                                        </div>
                                    } */}
                                </div>
